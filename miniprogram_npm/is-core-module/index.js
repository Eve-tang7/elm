...
__DEFINE__(1628732866329, function(require, module, exports) {
...
}, function(modId) {var map = {"./core.json":1628732866330}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1628732866330, function(require, module, exports) {
module.exports = {
	"assert": true,
	"node:assert": ">= 16",
	"assert/strict": ">= 15",
...
return __REQUIRE__(1628732866329);
})()
